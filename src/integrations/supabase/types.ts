...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          city: string | null;
          communication_style: Database["public"]["Enums"]["communication_style"] | null;
          country: string | null;
          created_at: string;
          ...
          relationship_intent: Database["public"]["Enums"]["relationship_intent"] | null;
    ...
    Enums: {
      ...
      billing_event_status: "received" | "processed" | "duplicate" | "ignored" | "failed";
      billing_interval: "month" | "year";
      billing_provider: "none" | "mock" | "stripe" | "paddle" | "apple" | "google" | "manual";
      children_plan:
        | "want_children"
        ...
        | "have_children"
        | "prefer_not_to_say";
      communication_style: "thoughtful" | "direct" | "playful" | "reserved" | "prefer_not_to_say";
      deletion_request_status: "pending" | "cancelled" | "completed";
      drinking_habit: "never" | "socially" | "regularly" | "prefer_not_to_say";
      entitlement_source: "web" | "ios" | "android" | "promotional" | "admin_grant";
      ...
      message_moderation_status: "unreviewed" | "cleared" | "flagged" | "removed";
      message_type: "text";
      moderation_case_status:
        "open" | "investigating" | "action_required" | "resolved" | "dismissed";
      moderation_priority: "low" | "medium" | "high" | "critical";
      moderation_source: "profile_report" | "message_report" | "safety_signal" | "manual";
      ...
      social_energy: "introvert" | "ambivert" | "extrovert" | "prefer_not_to_say";
      subscription_status:
...
export const Constants = {
  public: {
    Enums: {
      ...
      message_moderation_status: ["unreviewed", "cleared", "flagged", "removed"],
      message_type: ["text"],
      moderation_case_status: ["open", "investigating", "action_required", "resolved", "dismissed"],
      moderation_priority: ["low", "medium", "high", "critical"],
      moderation_source: ["profile_report", "message_report", "safety_signal", "manual"],
      notification_kind: ["support_reply", "support_status"],
      profile_visibility: ["everyone", "matches_only", "hidden"],
