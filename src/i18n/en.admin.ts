export const enAdmin = {
  ...
  admin: {
    ...
    staff: {
      ...
      grantTitle: "Grant a staff role",
      note: "Role changes are recorded in the audit log. You cannot change your own roles.",
      memberId: "Member ID",
      role: "Role",
      grant: "Grant role",
      revoke: "Revoke",
      saved: "Saved.",
      failed: "That change was refused.",
    },
    roles: {
